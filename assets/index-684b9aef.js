 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fV=5*60,pV=P1("authIdTokenMaxAge")||fV;let Ov=null;const mV=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>pV)return;const i=n==null?void 0:n.token;Ov!==i&&(Ov=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function gV(t=D1()){const e=Sp(t,"auth");if(e.isInitialized())return e.getImmediate();const n=WL(t,{popupRedirectResolver:uV,persistence:[wM,lM,cI]}),r=P1("authTokenSyncURL");if(r){const s=mV(r);rM(n,s,()=>s(n.currentUser)),nM(n,o=>s(o))}const i=C1("auth");return i&&qL(n,`http://${i}`),n}dV("Browser");function yV(){const[t,e]=R.useState(""),[n,r]=R.useState(!1),i=gV(XE);return iM(i,s=>{s?(r(!0),console.log("🚀 COMMANDER ~ file: App.tsx ~ line ~ 20 ~ ","user!!!")):(r(!1),JL(i).then(()=>{}).catch(o=>{e(o.message),console.log(o)}))}),Ce(Ei,{children:[t&&C("div",{children:t}),n&&C($C,{children:Ce(OC,{children:[C(Od,{path:"/:lang/:id",element:C(pL,{})}),C(Od,{path:"*",element:C(ID,{})})]})})]})}$h.createRoot(document.getElementById("root")).render(C(rn.StrictMode,{children:C(yV,{})}));
