 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iD{constructor(){this.k_=void 0,this.listeners=[]}}class sD{constructor(){this.queries=new ds(e=>KE(e),yc),this.onlineState="Unknown",this.q_=new Set}}async function oD(t,e){const n=j(t),r=e.query;let i=!1,s=n.queries.get(r);if(s||(i=!0,s=new iD),i)try{s.k_=await n.onListen(r)}catch(o){const a=cm(o,`Initialization of query '${oi(e.query)}' failed`);return void e.onError(a)}n.queries.set(r,s),s.listeners.push(e),e.Q_(n.onlineState),s.k_&&e.K_(s.k_)&&hm(n)}async function aD(t,e){const n=j(t),r=e.query;let i=!1;const s=n.queries.get(r);if(s){const o=s.listeners.indexOf(e);o>=0&&(s.listeners.splice(o,1),i=s.listeners.length===0)}if(i)return n.queries.delete(r),n.onUnlisten(r)}function lD(t,e){const n=j(t);let r=!1;for(const i of e){const s=i.query,o=n.queries.get(s);if(o){for(const a of o.listeners)a.K_(i)&&(r=!0);o.k_=i}}r&&hm(n)}function uD(t,e,n){const r=j(t),i=r.queries.get(e);if(i)for(const s of i.listeners)s.onError(n);r.queries.delete(e)}function hm(t){t.q_.forEach(e=>{e.next()})}class cD{constructor(e,n,r){this.query=e,this.U_=n,this.W_=!1,this.G_=null,this.onlineState="Unknown",this.options=r||{}}K_(e){if(!this.options.includeMetadataChanges){const r=[];for(const i of e.docChanges)i.type!==3&&r.push(i);e=new es(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.W_?this.z_(e)&&(this.U_.next(e),n=!0):this.j_(e,this.onlineState)&&(this.H_(e),n=!0),this.G_=e,n}onError(e){this.U_.error(e)}Q_(e){this.onlineState=e;let n=!1;return this.G_&&!this.W_&&this.j_(this.G_,e)&&(this.H_(this.G_),n=!0),n}j_(e,n){if(!e.fromCache)return!0;const r=n!=="Offline";return(!this.options.J_||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}z_(e){if(e.docChanges.length>0)return!0;const n=this.G_&&this.G_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}H_(e){e=es.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.W_=!0,this.U_.next(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RD{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Oa(this.observer.next,e)}error(e){this.observer.error?this.Oa(this.observer.error,e):Nn("Uncaught Error in snapshot listener:",e.toString())}Na(){this.muted=!0}Oa(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,zt=({name:t,value:e,className:n,setValue:r,style:i})=>Re("label",{style:i,css:w2,className:n+" checkbox "+t+" checkbox "+(e==="1"?"checked":""),children:[C("input",{name:t,type:"checkbox",className:n,checked:e==="1",onChange:s=>{r(t,s.target.checked?"1":"0")}}),C("div",{className:"checkmark"})]}),E2=W`
  display: block;
...
`,je=({name:t,value:e="",className:n="",setValue:r})=>{let i="text",s=1e4,o=-1e4,a=1e4;return/\bval\b/.test(n)&&(i="number",s=20,o=1,a=2),/\bnbr\b/.test(n)&&(i="number"),C("input",{value:e,type:i,name:t,max:s,min:o,onFocus:l=>l.target.select(),maxLength:a,className:`${n} ${t}`.trim(),onChange:l=>{r(t,l.target.value)},css:E2})},T2=W`
  margin-top: 1.7em;
  display: flex;
...
`,S2=({data:t,setValue:e})=>{const n=[],r=[],i=["str","con","agl","int","wil","cha"],s=["exhausted","sickly","dazed","angry","scared","disheartened"];for(let o=0;o<6;o++){const a="condition-"+s[o];r.push(C(zt,{name:a,value:t[a],setValue:e},a))}for(let o=0;o<6;o++){const a="attribute-"+i[o];n.push(C(je,{className:"val",name:a,value:t[a],setValue:e},a))}return Re(Qr,{children:[C("div",{css:T2,children:n}),C("div",{css:I2,children:r})]})},A2=W`
  background-color: transparent;
  background-color: rgba(255, 165, 0, 0.1);
  ...
  width: 100%;
  overflow: hidden;
`,fu=({name:t,value:e="",className:n="",setValue:r})=>C("textarea",{css:A2,name:t,value:e,maxLength:1e4,className:n+" "+t,onChange:s=>{r(t,s.target.value)}}),k2=W`
  input {
...
`,P2=({data:t,setValue:e})=>{const n=[],r=["player","kin","age","profession"];for(let i=0;i<4;i++){const s="info-"+r[i];n.push(C(je,{className:"name",name:s,value:t[s],setValue:e},s))}return Re(Qr,{children:[Re("div",{css:k2,children:[n,C(fu,{name:"info-weakness",value:t["info-weakness"],setValue:e})]}),C("div",{css:C2,children:C(je,{className:"name",name:"info-name",value:t["info-name"],setValue:e})}),C("div",{css:R2,children:C(fu,{name:"info-appearance",value:t["info-appearance"],setValue:e})})]})},N2=W`
  position: absolute;
  width: 10.8em;
  height: 28rem;
  left: 0.3em;
...
`,L2=({data:t,setValue:e})=>{const n=[],r=[],i=[],s=["dmg-bonus-str","dmg-bonus-agl","movement"],o=["gold","silver","copper"],a=["inventory","memento","tiny-items"];for(let l=0;l<3;l++){const u=s[l];i.push(C(je,{className:"",name:u,value:t[u],setValue:e},u))}for(let l=0;l<3;l++){const u="coins-"+o[l];n.push(C(je,{name:u,value:t[u],setValue:e},u))}for(let l=0;l<3;l++){const u=a[l];r.push(C(fu,{name:u,value:t[u],setValue:e},u))}return Re(Qr,{children:[C("div",{css:O2,children:i}),Re("div",{css:N2,children:[C(fu,{name:"abilities-and-spells",value:t["abilities-and-spells"],setValue:e}),C("div",{css:x2,children:n})]}),Re("div",{css:D2,children:[C(je,{className:"val",name:"encumberance-limit",value:t["encumberance-limit"],setValue:e}),r]})]})},OT=53.1,V2=OT*1.291764706,M2=W`
  margin: 0 auto;
  width: ${OT}rem;
  height: ${V2}rem;
  position: relative;
...
`,K2=({data:t,setValue:e,lang:n})=>{const r=[],i=[],s=[],o=[];for(let a=1;a<21;a++){let l="wp-check-"+a;r.push(C(zt,{name:l,value:t[l],setValue:e},l)),l="hp-check-"+a,i.push(C(zt,{name:l,value:t[l],setValue:e},l))}for(let a=1;a<4;a++){let l="death-roll-success-"+a;s.push(C(zt,{className:`lang-${n}`,name:l,value:t[l],setValue:e},l)),l="death-roll-failure-"+a,o.push(C(zt,{className:`lang-${n}`,name:l,value:t[l],setValue:e},l))}return Re(Qr,{children:[Re("div",{css:j2,children:[C(zt,{style:{margin:`${n==="sv"?"0 4em 0 2.75em":"0 4.2em 0 2em"}`},name:"round-rest",value:t["round-rest"],setValue:e}),C(zt,{name:"stretch-rest",value:t["stretch-rest"],setValue:e})]}),C("div",{css:wm,children:r}),C("div",{css:W2,children:i}),Re("div",{css:q2,children:[s,o]}),C(je,{css:DT,className:"val",name:"wp-points",value:t["wp-points"],setValue:e}),C(je,{css:H2,className:"val",name:"hit-points",value:t["hit-points"],setValue:e})]})},G2=W`
  .checkbox {
    display: block;
